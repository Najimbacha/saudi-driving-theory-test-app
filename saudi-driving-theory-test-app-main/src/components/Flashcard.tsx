      ...
      >
        ...
        <div className="absolute inset-0 backface-hidden rotate-y-180">
          <div className="w-full h-full bg-gradient-to-br from-primary to-primary/80 rounded-3xl shadow-xl flex flex-col items-center justify-center p-6 gap-4 text-primary-foreground">
            ...
            <p className="text-center text-lg leading-relaxed text-primary-foreground">{back}</p>
            {tip && (
              <div className="mt-4 p-3 bg-primary-foreground/10 rounded-xl">
                <p className="text-sm text-center text-primary-foreground">{tip}</p>
              </div>
            )}
            <div className="absolute bottom-4 flex items-center gap-2 text-primary-foreground text-sm">
              <RotateCcw className="w-4 h-4" />
