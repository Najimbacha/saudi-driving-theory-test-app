...
interface AppContextType {
  ...
  stats: { quizzesTaken: number; bestScore: number; totalCorrect: number; totalAnswered: number };
...
export function AppProvider({ children }: { children: ReactNode }) {
  ...
  const [stats, setStats] = useState(() => {
    ...
    return saved ? JSON.parse(saved) : { quizzesTaken: 0, bestScore: 0, totalCorrect: 0, totalAnswered: 0 };
  });
