    ...
    <div className="min-h-screen bg-gradient-hero flex flex-col items-center justify-center p-6 text-primary-foreground">
      {step === 0 && (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-md w-full">
          ...
          <p className="text-lg opacity-90 mb-8">{t('onboarding.selectLanguage')}</p>
          ...
          <p className="text-sm opacity-70 mb-6">{t('onboarding.languageNote')}</p>
      ...
      {step === 1 && (
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center max-w-md w-full">
          ...
          <p className="text-lg opacity-90 mb-8">{t('onboarding.offlineDesc')}</p>
