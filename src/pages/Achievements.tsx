      ...
      <main className="p-4 space-y-6">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            <div>
              <p className="text-sm opacity-80">{t('achievements.level')}</p>
          ...
          <div className="flex items-center justify-between mt-4 pt-4 border-t border-background/20">
            <div className="text-center">
              ...
              <p className="text-xs opacity-80">{t('achievements.unlocked')}</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold">{achievements.length}</p>
              <p className="text-xs opacity-80">{t('achievements.total')}</p>
            </div>
            <div className="text-center">
              <p className="text-2xl font-bold">
                {Math.round((unlockedAchievements.length / achievements.length) * 100)}%
              </p>
              <p className="text-xs opacity-80">{t('achievements.progress')}</p>
            </div>
          </div>
        </motion.div>
