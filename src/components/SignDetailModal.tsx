...
export const SignDetailModal: React.FC<SignDetailModalProps> = ({
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      ...
      case 'regulatory': return 'bg-red-500/20 text-red-700 dark:text-red-400';
      case 'mandatory': return 'bg-blue-500/20 text-blue-700 dark:text-blue-400';
      case 'guide': return 'bg-green-500/20 text-green-700 dark:text-green-400';
